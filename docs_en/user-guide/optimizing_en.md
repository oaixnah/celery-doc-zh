...
The point of this exercise [^1] is to show that there's a limit
...
available worker nodes that may be able to process them sooner [^2],
...
of concurrency slots [^3] (processes/threads/green-threads).
